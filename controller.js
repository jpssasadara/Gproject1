...
app.config(function($routeProvider) {
   $routeProvider
   //routing for 1 st  page and redirection for worrng routing
    .when("/", {
    ...
    // routing for farmshop welcome page
    ...
    // routing for Admin Dashboard page
     ...
     // routing for farm shop page
      ...
      // routing for registration form admin page
      .when("/admin_register",{
        resolve:{
            "check":function($location,$cookies,$rootScope){
                if(!$cookies.get('cookie')){
   ...
   // routing for Report page
     ...
     .when("/admin/forummessage",{                    
      ...
      // routing for farmer registration form page
     ...
     //Isuru >>>  for view reg farmers page
     ...
     // ISURU >> Registered shop view page
     .when("/admin/ShopView",{                    
        resolve:{
            "check":function($location,$cookies,$rootScope){
                if(!$cookies.get('cookie')){
   ...
   //  view courses page
     ...
     //**********************************************************************************************
     //                        Mainly  Related part with Mobile Application
     //********************************************************************************************

       // view Registered farmers orders page <<< Admin Dashboard
       ...
       // view Registered farmers orders page <<< form inner button 
       ...
       // view verified order   page
          ...
          //view deliverd order page
           ...
           //sending email from view orders opening view for write email page
         ...
         //*************************************************************************************************************
         //                                     Handeling items (Vegetables/fruits/shop/stores) 
         //*************************************************************************************************************
        // routing for Adding items details page (name,code,etc..)
        ...
        // routing for loading Items to store page
           ...
           // load Items To Stores From Regfarmers products
