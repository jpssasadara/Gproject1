...
$sql = "INSERT INTO bid_history (Bidder,Item_code, Amount, Date,confirm,reject)
    values ('$_POST[id]','$_POST[code]','$_POST[amount]', '$_POST[date]',false,false)";

if ($mysqli->query($sql) === TRUE) {
    echo "<hr>New record created successfully<br>";
    echo "<a href='AuctionHomeShop.php'>Click Here to AuctionHome</a>";
} else {
